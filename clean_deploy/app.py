...
def create_app():
    ...
    app.config['WTF_CSRF_ENABLED'] = False  # Disable CSRF for Azure deployment
    ...
    print(f"POSTGRES_PASSWORD: {'Present' if postgres_password else 'Missing'}")
    ...
    if database_url.startswith('postgresql://'):
        ...
        if postgres_password:
            ...
            if '@' in database_url and ':' not in database_url.split('@')[0].split('//')[-1]:
                ...
                print("Password injection applied to database URL")
