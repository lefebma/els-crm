...
// Allow Azure IPs for public access (temporary)
...
// Firewall rule to allow Azure services (if enabled)
resource allowAzureIpsFirewallRule 'Microsoft.DBforPostgreSQL/flexibleServers/firewallRules@2022-12-01' = if (allowAzureIPsFirewall) {
